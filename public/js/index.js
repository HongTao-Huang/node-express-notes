...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (immutable) */ __webpack_exports__["a"] = Toast;
...
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mod_note_manager__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_mod_waterfall__ = __webpack_require__(15);


__webpack_require__(16);
const Event = __webpack_require__(3);

let noteManager = new __WEBPACK_IMPORTED_MODULE_0_mod_note_manager__["a" /* default */]();
let WaterFall = new __WEBPACK_IMPORTED_MODULE_1_mod_waterfall__["a" /* default */]();
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mod_toast__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_mod_note__ = __webpack_require__(12);
        ...
        .done(function(ret){
            if(ret.status == 0){
                $.each(ret.data, function(idx, article) {
                    new __WEBPACK_IMPORTED_MODULE_1_mod_note__["a" /* default */]({
                        id: article.id,
                ...
                Object(__WEBPACK_IMPORTED_MODULE_0_mod_toast__["a" /* default */])(ret.errorMsg);
            }
        })
        .fail(function(){
            Object(__WEBPACK_IMPORTED_MODULE_0_mod_toast__["a" /* default */])(this.a);
        });
    }
...
// module
exports.push([module.i, ".toast {\n  position: fixed;\n  left: 50%;\n  bottom: 20px;\n  color: #D15A39;\n  background-color: #fff;\n  padding: 5px 10px;\n  border-radius: 3px;\n  box-shadow: 0px 0px 1px 3px rgba(255, 255, 255, 0.6);\n  box-shadow: 0px 0px 1px 3px rgba(0, 0, 0, 0.1);\n  display: none;\n}\n", ""]);
...
class Note{
    ...
    setLayout(){
        var that = this;
        if(that.clk){
            clearTimeout(that.clk);
        }
        that.clk = setTimeout(function(){
            Event.fire('waterfall');
        },100);
    }
    ...
    bindEvent () {
        ...
        $noteCt.on('focus', function() {
            ...
            if( $noteCt.data('before') != $noteCt.html() ) {
                ...
                that.setLayout();
                if(that.id){
                    that.edit($noteCt.html())
                }else{
                    that.add($noteCt.html())
                }
            }
        });
    ...
    edit (msg) {
        ...
        $.post('/api/notes/edit',{
            ...
            if(ret.status === 0){
                Object(__WEBPACK_IMPORTED_MODULE_0_mod_toast__["a" /* default */])('update success');
            }else{
                Object(__WEBPACK_IMPORTED_MODULE_0_mod_toast__["a" /* default */])(ret.errorMsg);
            }
        })
    ...
    add (msg){
        ...
        $.post('/api/notes/add', {note: msg})
            .done(function(ret){
                if(ret.status === 0){
                    Object(__WEBPACK_IMPORTED_MODULE_0_mod_toast__["a" /* default */])('add success');
                }else{
                    that.$note.remove();
                    Event.fire('waterfall')
                    Object(__WEBPACK_IMPORTED_MODULE_0_mod_toast__["a" /* default */])(ret.errorMsg);
    ...
    delete(){
        ...
        $.post('/api/notes/delete', {id: this.id})
            .done(function(ret){
                if(ret.status === 0){
                    Object(__WEBPACK_IMPORTED_MODULE_0_mod_toast__["a" /* default */])('delete success');
                    that.$note.remove();
                    Event.fire('waterfall')
                }else{
                    Object(__WEBPACK_IMPORTED_MODULE_0_mod_toast__["a" /* default */])(ret.errorMsg);
